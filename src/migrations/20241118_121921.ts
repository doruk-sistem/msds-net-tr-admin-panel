...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_msds_fk" FOREIGN KEY ("msds_id") REFERENCES "public"."msds"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "msds_updated_at_idx" ON "msds" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "msds_created_at_idx" ON "msds" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "msds_filename_idx" ON "msds" USING btree ("filename");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_msds_id_idx" ON "payload_locked_documents_rels" USING btree ("msds_id");
